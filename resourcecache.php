...
class qbehaviour_opaque_resource_cache {
    ...
    /** @var string Path to the folder where resources for this question are cached. */
    protected $folder;

    /** @var string Path to the folder where mime types are stored. */
    protected $metadatafolder;

    /** @var string Initial part of the URL to link to a file in the cache. */
    protected $baseurl;
